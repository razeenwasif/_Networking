...
def readLine(sock):
    ...
    txt = inData.decode('utf-8', 'backslashreplace').strip() 
    # the strip() is used to remove the newline character, leading and trailing whitespace,
    # including spaces and tabs from the decoded string before returning it
    return txt

 ...
 *
 * <p>Run with java TcpClient [ IP addr ] [ port ]
 *
...
public class TcpClient {
  ...
  protected static void inputLoop(String host, int port) throws IOException {
    Socket sock;
  ...
  protected static void readReply(Socket sock) throws IOException {
    String reply;

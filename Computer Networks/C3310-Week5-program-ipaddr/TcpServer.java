 ...
 *
 * <p>Run with java TcpServer [ port ]
 *
 * <p>Written by Hugh Fisher u9011925, ANU, 2024 Released under Creative Commons CC0 Public Domain
 * Dedication This code may be freely copied and modified for any purpose
 */
import java.io.*;
import java.net.*;
...
public class TcpServer {
  ...
  protected static void clientLoop(int port) throws IOException, SocketException {
    ...
    // If you don't, you may have to wait a few minutes before restarting the
    // server.
    serverSock.setReuseAddress(true);
    System.out.printf(
        "Created server socket for %s %d\n",
  ...
  protected static void serverLoop(Socket sock) throws IOException {
    String request;
  ...
  protected static void handleRequest(Socket sock, String message) throws IOException {
